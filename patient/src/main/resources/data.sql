-- Ensure the 'PATIENT_CLASS' table exists
CREATE TABLE IF NOT EXISTS PATIENT_CLASS
(
    id              UUID PRIMARY KEY,
...
INSERT INTO PATIENT_CLASS (id, name, email, address, date_of_birth, registered_date)
